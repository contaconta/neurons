...
%         CLASSIFIER.weak_learners{t}.alpha = alpha;
%         CLASSIFIER.weak_learners{t}.index = BEST_learner;
%         %CLASSIFIER.weak_learners{t}.type = weak_classifier.;
%     end
...
%     % THIS WAS SUPPOSED TO COMPARE HAARS AND SPEDGES!
%     %%%%%%%%%%%%%%%%%%% DEBUG %%%%%%%%%%%%%%%%%%%%
%     for i = 1:length(WEAK.learners)
%         [m1, v1] = min(WEAK.error(t));
%         if m1 == min(WEAK.error); prestr = '     ✓ '; else prestr = '       '; end
%         s = [prestr 'best ' WEAK.learners{i}.type ' error: ' num2str(m1) ', feature index: ' num2str(v1)];
%         disp(s);
%     end
%     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
