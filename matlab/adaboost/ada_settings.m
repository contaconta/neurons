...
FILES.cascade_filenm  = 'CASCADE.mat';                  % filename to store the cascaded classifier
FILES.log_filenm      = 'CASCADE.log';                  % filename to store the log file    
...
% LEARNERS(length(LEARNERS)).IMSIZE           = IMSIZE;
% LEARNERS(length(LEARNERS)).angles           = 0:30:360-30;
% LEARNERS(length(LEARNERS)).sigma            = 2;  %[1 1.5 2 3];  %2;
