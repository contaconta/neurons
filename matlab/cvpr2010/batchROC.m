...
annFolder = '~/Dropbox/share/work/EM/mitoAnnotations/';

% folder containing SUBFOLDERS with experiments to construct ROCs
estFolders = '/localhome/aurelien/share/EM/UnaryTerm3_perfectpairwise/';

% folder to write the ROC data to
destinationFolder = '/localhome/aurelien/share/EM/UnaryTerm3_perfectpairwise/';
...
for i = 1:length(d)
    ...
    [tpr{i} fpr{i}] = folderROC(estFolder1, GT);
