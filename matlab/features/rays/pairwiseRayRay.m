...
for k = 1:5
    ...
    for i = trainImgs
        ...
        for p = plist
            ...
            featureVector(c,:) = [RAYFEATUREVECTOR(p,:) RAYFEATUREVECTOR(bg,:)];
        ...
        for p = plist
            ...
            featureVector(c,:) = [RAYFEATUREVECTOR(p,:) RAYFEATUREVECTOR(mt,:)];          
            c = c + 1;
        end
        ...
        for n = nlist
            ...
            featureVector(c,:) = [RAYFEATUREVECTOR(n,:) RAYFEATUREVECTOR(mt,:)];
            c = c + 1;
        end
        ...
        for n = nlist
            ...
            featureVector(c,:) = [RAYFEATUREVECTOR(n,:) RAYFEATUREVECTOR(bd,:)];
            c = c + 1;
        end
        ...
        for n = nlist
            ...
            featureVector(c,:) = [RAYFEATUREVECTOR(n,:) RAYFEATUREVECTOR(im,:)];
            c = c + 1;
        end
        ...
        for n = nlist
            ...
            featureVector(c,:) = [RAYFEATUREVECTOR(n,:) RAYFEATUREVECTOR(bg,:) ];
            c = c + 1;
        end
    ...
    for i = testImgs
        ...
        for x = 1:length(r)
            featureVector1(x,:) = [RAYFEATUREVECTOR(r(x),:) RAYFEATUREVECTOR(c(x),:) ];
            featureVector2(x,:) = [RAYFEATUREVECTOR(c(x),:) RAYFEATUREVECTOR(r(x),:) ];
