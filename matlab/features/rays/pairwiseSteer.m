...
%             featureVector2(x,:) = [RAYFEATUREVECTOR(c(x),:) H(c(x),:)  RAYFEATUREVECTOR(r(x),:) H(r(x),:)];
            featureVector1(x,:) = [S(r(x),:)  S(c(x),:)];
            featureVector2(x,:) = [S(c(x),:)  S(r(x),:)];
