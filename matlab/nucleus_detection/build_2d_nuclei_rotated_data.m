...
pos_train_path = '/osshare/Work/Data/nuclei48/train/pos/';
neg_train_path = '/osshare/Work/Data/nuclei48/train/neg/';
pos_test_path  = '/osshare/Work/Data/nuclei48/test/pos/';
neg_test_path  = '/osshare/Work/Data/nuclei48/test/neg/';
...
%         
%         xadd = round(BB(3) * BORDER);
%         yadd = round(BB(4) * BORDER);
%         
%         rect = BB + [-xadd -yadd 2*xadd 2*yadd];
%         
%         I = GT(t).Image(:,:);
%         I = imcrop(I, rect);
%         
...
%     end
    ...
    if ~overlapsGT
        EXAMPLE = imresize(EXAMPLE, IMSIZE);
        nstr = number_into_string(n, 10000);
        test_file1 = [neg_train_path 'non' nstr '.png'];
