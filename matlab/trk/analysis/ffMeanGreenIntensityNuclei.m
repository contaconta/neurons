function rvc = ffMeanGreenIntensityNuclei(R, varargin)
...
for d = 1:length(R.D)
   ...
   if(isempty(R.D(d).MeanGreenIntensity))
     disp('encountered an empty value in ffMeanGreenIntensityNuclei');
     keyboard; 
   end
   nPoints = nPoints+1;

   rvc(nPoints) = R.D(d).MeanGreenIntensity;
end
