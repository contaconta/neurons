...
TEST_POS =  1000;   % number of positive examples in the test set
TEST_NEG  = 1000;   % number of negative examples in the test set
NORM      = 1;      % normalize the variance of image intensity?
cascade_filenm = 'CASCADE_1000.mat';    % filename to store your learned cascade
log_filenm = 'CASCADE_1000.log';
