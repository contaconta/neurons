...
#  ENDIF(${swig_source_file_path} MATCHES "^${CMAKE_CURRENT_SOURCE_DIR}")
  SET(swig_source_file_abosolute_path 1)
  ...
  IF(swig_source_file_abosolute_path)
    SET(swig_generated_file_fullname ${swig_outdir})
  ENDIF(swig_source_file_abosolute_path)
  ...
  # This prevents the generation of bad assembler for the Java JNI code.
  # This is actually due to buggy SWIG automatically generated code, not a
  # compiler bug.
