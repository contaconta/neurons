...
static char doc[] =
  "outputs the coefficients of a gaussian mask orthogonal of a given sigman and a given derivative order";
...
int main(int argc, char **argv) {
  ...
  vector< float > mask = Mask::gaussian_mask_orthogonal(order, sigma, true);
