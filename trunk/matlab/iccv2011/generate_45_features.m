function [rects, cols, types, X, Y, weights] = generate_45_features(IMSIZE, varargin)
                    ...
                    if isempty(find(ROW > IISIZE(1),1)) && isempty(find(ROW < 1,1))
                        if isempty(find(COL > IISIZE(2),1)) && isempty(find(COL < 1,1))
                            ...
                            if mod(ca,2) == 0
                                ...
                                Y{cnt} = {[A1(1) B1(1) C1(1) D1(1)], [A2(1) B2(1) C2(1) D2(1)]};
                                X{cnt} = {[A1(2) B1(2) C1(2) D1(2)], [A2(2) B2(2) C2(2) D2(2)]};

                                for k = 1:length(Y{cnt})
                                    [vals, inds] = sort(Y{cnt}{k});
                                    Y{cnt}{k} = Y{cnt}{k}(inds);
                                    X{cnt}{k} = X{cnt}{k}(inds);
                                end
                            ...
                            if mod(ca,3) == 0
                                ...
                                Y{cnt} = {[A1(1) B1(1) C1(1) D1(1)], [A2(1) B2(1) C2(1) D2(1)], [A3(1) B3(1) C3(1) D3(1)]};
                                X{cnt} = {[A1(2) B1(2) C1(2) D1(2)], [A2(2) B2(2) C2(2) D2(2)], [A3(2) B3(2) C3(2) D3(2)]};
